class Docente {
 ...
 class Entrega {
  constructor(usuarioAlumno, id_tarea, audio, devoluciones, nota_final, comentario, estado) {
 ...
 class Tarea {
  constructor(unaTarea, unTitulo, unaDescripcion, unNivel, unaNota, unaImagen) {
    this.idTarea = unaTarea;
    this.titulo = unTitulo;
    this.descripcion = unaDescripcion;
    this.nivel = unNivel;
    this.notaMax = unaNota;
...
function crearTarea(profesorUsr, titulo, descripion, img, notaMax, nivel) {
  // SOLO PROFESOR
  const nuevaTarea = {
    idTarea: profesorUsr.tareasPlanteadas.length,
...
function getDocente(usuarioId) {
  return docentesList.some((docente) => docente.usuario === usuarioId);
  // Some retorna true si hay un docente que cumpla ese id

  // Busca un docente, cuyo usuario sea usuario id.
  // Si no existe da undefined si existe te da el docente return docentesList.find((docente) => docente.usuario === usuarioId); 
